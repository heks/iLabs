...
mobileApp.controller('analyzeCtrl',
  function analyzeCtrl($scope, $location){
      ...
      $scope.localGraph = function(){
        ...
        series: [{name: 'Trial1',data: [5,10,15]},
                  {name: 'Trial2',data: [8,12,14]}
    ...
    //localStorage.setItem('datauri',img);
    $('#data_URI').html(img);
...
//var imgData = localStorage.getItem('datauri');
...
doc.setFontSize(16);
doc.text(20,91,'"Distances (mm)","Trial1( particle counts)"');
doc.text(20,97,'"50","9"');
doc.text(20,104,'"55","8"');
...
//doc.output('datauri');
      ...
      $scope.Exitlab = function(){
        ...
        //$('#Interpret1').html($scope.Intertxt1);
        //$('#Interpret2').html($scope.Intertxt2);
      }
