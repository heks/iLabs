angular.module('service', []).constant('dev_server', 'http://devloadbalancer-822704837.us-west-2.elb.amazonaws.com').constant('other_server', 'http://54.200.25.203').service('api', [
  '$http',
  'dev_server',
  'other_server',
  '$rootScope',
  function ($http, dev_server, other_server, $rootScope) {
    var username;
    var api_key;
    var assignments = [];
    var suscriptions = [];
